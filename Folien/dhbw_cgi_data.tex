...
\begin{frame}
    ...
    \end{block}
        \begin{figure}
        \centering
        \includegraphics[width=0.\textwidth]{images/halfedge.png}
    \end{figure}
\end{frame}
...
\begin{frame}
    ...
    \begin{align*}
    \text{Anzahl Ebenen} \approx 1 + \lfloor \log_2(\max(w,h)) \rfloor
    \end{align*}
\end{frame}
...
\begin{frame}
    \frametitle{Algorithmen und Datenstrukturen}
    \framesubtitle{Uniform Grids}
    \small
    \begin{block}{Grundidee}
    Der Raum wird in gleich gro{\ss}e Zellen zerlegt. Objekte werden in die
    Zellen einsortiert, die sie schneiden. Nachbarschaftsanfragen m\"ussen dann
    nur lokale Zellen betrachten.
    \end{block}

    \begin{block}{Warum das funktioniert}
    Bei vielen Problemen sind nur lokale Wechselwirkungen relevant, etwa bei
    Kollision, Partikelinteraktion oder Nachbarsuche. Dann ist es ineffizient,
    alle Objekte global miteinander zu vergleichen.
    \end{block}
\end{frame}
...
\begin{frame}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.7\textwidth]{images/Voxelgitter.png}
    \end{figure}
\end{frame}
...
\begin{frame}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.5\textwidth]{images/marchingcubes_head.png}
    \end{figure}
\end{frame}
