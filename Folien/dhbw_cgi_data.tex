...
\begin{frame}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.7\textwidth]{images/lod}
    \end{figure}
\end{frame}
...
\begin{frame}
    ...
    \small
    \begin{block}{Mesh Simplification}
    In der CityGML-Spezifikation wurden mehrere LOD-Stufen
    herausgearbeitet, die vielen deutschen Stadtmodellen zugrunde liegen:

    \begin{itemize}
        \item LOD 0: Regionalmodell, 2,5-D-Geländemodell mit Luftbildtextur
        \item LOD 1: Klötzchenmodell, Gebäudeblock (Grundfläche hochgezogen)
        \item LOD 2: 3D-Modell der Außenhülle mit Dachstrukturen und einfachen Texturen
        \item LOD 3: Architekturmodell, 3D-Modell der Außenhülle mit Textur
        \item LOD 4: Innenraummodell, 3D-Modell des Gebäudes mit Etagen, Innenräumen etc. und Texturen
    \end{itemize}
