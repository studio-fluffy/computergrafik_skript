...
\includegraphics[scale=0.8]{images/Flugsimulator} \includegraphics[scale=0.8]{images/Immersive_Simulation}
\end{block}
\end{frame}
...
\begin{center}
\includegraphics[scale=0.6]{images/Pong} \includegraphics[scale=0.12]{images/freestyle.png}
\end{center}
\end{block}
\end{frame}
...
\frametitle{Computergrafik}
\framesubtitle{Anwendungen}
 \begin{block}{Computer Added Engineering (CAE)}
\begin{center}
\includegraphics[scale=0.3]{images/cae.jpg}
\end{center}
\end{block}
\end{frame}
